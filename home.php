                ...
                <div class="first_1">
                    <div class="menu">
                        <div class="menu1">
                            ...
                            <div class="name1">
                                <p class="hotel1"><a href="kaleidoscope.php">Kaleidoscope Multicuisine</a></p>
                            </div>
                        </div>
                        <div class="menu2">
                            <div class="food2">
                            ...
                            <div class="name2">
                                <p class="hotel2"><a href="rangde.php" id="link1">Rang De Basanti Dhaba</a></p>
                            </div>						
                        </div>
                    </div>
                    <div class="switch">
                    ...
                    <div class="restrau_1">
                        <div class="menu_">
                            <div class="menu_1">
                                ...
                                <div class="name_1">
                                    <p class="hotel_1"><a href="baskin.php">Baskin Robbins</a></p>
                                </div>							
                            </div>
                            <div class="menu_2">
                                <div class="food_2">
                                ...
                                <div class="name_2">
                                    <p class="hotel_2"><a href="cream.php">The Cream And Fudge Factory</a></p>
                                </div>
                            </div>
                        </div>
                        <div class="switch_">
